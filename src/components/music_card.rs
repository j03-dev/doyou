...
#[component]
pub fn MusicCard(item: Item, rw_signal: RwSignal<Option<Item>>) -> impl IntoView {
    ...
    view! {
        <li class="list-row">
            ...
            <div>
                ...
                <button class="btn btn-square btn-ghost" on:click=move |_| rw_signal.set(Some(item.clone()))>
